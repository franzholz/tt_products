...
$result = [
    ...
    'types' => [
        '0' => [
                ...
                'showitem' => 'title, subtitle, slug, parent_category, catid, keyword, note, note2, email_uid, image_uid, sliderimage_uid,  discount,discount_disable,highlight,tstamp,crdate,hidden,
